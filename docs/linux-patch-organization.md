...
| `patches-peripherals/linux` | 16 | DW MMC/IDMAC, dual SD/C6 slots, ESP-Hosted integration, and the Linux-owned Kit C DSI handoff framebuffer | Experimental driver series; preserve order until fixups are squashed and converted from polling to normal interrupt-driven operation |
