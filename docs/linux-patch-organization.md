...
| `patches-peripherals/linux` | 17 | DW MMC/IDMAC, dual SD/C6 slots, ESP-Hosted integration, and the Linux-owned Kit C DSI framebuffer and polled GT9271 input | Experimental driver series; preserve order until fixups are squashed and the remaining P4 CLIC-dependent polling paths can be evaluated for interrupt-driven operation |
